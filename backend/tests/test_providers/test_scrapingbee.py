...
@pytest.mark.asyncio
async def test_multi_city_keeps_fast_pass_when_summary_matches_visible_cheapest(
    provider: ScrapingBeeProvider,
) -> None:
    provider._client.get = AsyncMock(
        return_value=mock_response(
                            ...
                            "cards": [
                                {
                                    ...
                                    "price_text": "$983",
                                    "booking_href": "/book/cheapest-visible",
                                    "cabin": "Economy Cabin",
                                    "airline_text": "Philippine Airlines / XiamenAir",
                                    "legs": [
                                        {
                                            "text": "YVR Vancouver Intl - DPS Bali Ngurah Rai 1 stop 31h 50m",
                                            "airline": "Philippine Airlines",
                                            "time_text": "1:05 am - 11:55 pm+1",
                                            "route_text": "YVR Vancouver Intl - DPS Bali Ngurah Rai",
                                            "stops_text": "1 stop",
                                            "layover_text": "MNL 1h 05m layover, Manila",
                                            "duration_text": "31h 50m",
                                        },
                                        {
                                            "text": "SIN Changi - YVR Vancouver Intl 1 stop 31h 00m",
                                            "airline": "XiamenAir",
                                            "time_text": "2:40 am - 6:40 pm",
                                            "route_text": "SIN Changi - YVR Vancouver Intl",
                                            "stops_text": "1 stop",
                                            "layover_text": "XMN 1h 30m layover, Xiamen",
    ...
    assert len(results) == 1
    assert results[0].price == 983.0
    assert results[0].airline == "Philippine Airlines / XiamenAir"
    assert results[0].deep_link == "https://www.kayak.com/book/cheapest-visible"
