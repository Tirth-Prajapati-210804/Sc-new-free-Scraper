...
@pytest.mark.asyncio
async def test_searchapi_pool_falls_back_to_next_key(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    from app.providers import searchapi as searchapi_module
    ...
    monkeypatch.setattr(searchapi_module, "SearchApiProvider", DummyProvider)

    provider = SearchApiPoolProvider(
